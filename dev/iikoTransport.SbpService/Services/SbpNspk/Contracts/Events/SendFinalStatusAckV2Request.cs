...
{
    /// <summary>
    /// Данные Уведомления для Агента ТСП о финальном статусе Операции СБП C2B от ОПКЦ СБП (v2).
    /// </summary>
    [DataContract]
    public class SendFinalStatusAckV2Request
    {
        public SendFinalStatusAckV2Request(string qrcId, string trxId, string paramsId, string status, int amount, string errorCode, string message,

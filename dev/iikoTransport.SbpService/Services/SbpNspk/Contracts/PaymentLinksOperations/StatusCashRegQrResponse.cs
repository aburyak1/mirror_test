...
{
    /// <summary>
    /// Данные успешного ответа на запрос метода "Статус Операции по Кассовой ссылке СБП (v1)".
    /// </summary>
    [DataContract]
    public class StatusCashRegQrResponse
    {
        public StatusCashRegQrResponse(string cashRegisterQrcStatus, string trxStatus, string? trxId, string amount, string? timestamp,
